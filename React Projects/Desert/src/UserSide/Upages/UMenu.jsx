...
const MenuData = async () => {
  ...
  className={`filtbtn ${category === "All" ? "active" : ""}`}
>
  All
</button>
...
<button
  ...
  className={`filtbtn ${category === "Burger" ? "active" : ""}`}
>
  Burgers
</button>
...
<button
  ...
  className={`filtbtn ${category === "Pizza" ? "active" : ""}`}
>
  Pizza
</button>
...
<button
  ...
  className={`filtbtn ${category === "Chicken" ? "active" : ""}`}
>
  Chicken
</button>
...
<button
  ...
  className={`filtbtn ${category === "Wraps" ? "active" : ""}`}
>
  Wraps
</button>
...
<button
  ...
  className={`filtbtn ${category === "Desserts" ? "active" : ""}`}
>
  Desserts
</button>
...
<button
  ...
  className={`filtbtn ${category === "Pasta" ? "active" : ""}`}
>
  Pasta
</button>
      </div>
      <div className="row  g-4" id="mgrid">
        ...
        {
          filterData && filterData.map((dets)=>{
              return (
                <div  className="col-sm-6 col-lg-4  mwrap" data-c="burgers" data-aos="fade-up">
          <div className="mcard" style={{height:'470px'}} data-img="img/menu/1.jpg" data-title="Classic Smash Burger" data-cat="Burgers" data-price="$14.99" data-old="$18.99" data-rating="4.9" data-reviews={128} data-cal={620} data-time={12} data-desc="Double smashed patty, cheddar cheese, caramelized onions, house pickles and our legendary special sauce. Made fresh to order on a toasted brioche bun." data-tags="Spicy,Bestseller,Beef">
            <div className="mimg ">
              <img src={dets.image} alt="Smash Burger" />
              <div className="mbdg hot"><i className="fas fa-star" /> {dets.tag}</div>
              <div className="mhrt"><i className="far fa-heart" /></div>
            </div>
            <div className="mbody">
              <div className="mcat">{dets.category}</div>
              <div className="mtit">{dets.title}</div>
              <div className="mdesc">{dets.desc}</div>
              <div className="mfoot">
                <div>
                  <div className="mprice">{dets.price}<small>$18.99</small></div>
