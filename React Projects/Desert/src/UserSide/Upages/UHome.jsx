      ...
      <div className="row align-items-center g-5" style={{minHeight: '88vh'}}>
        <div className="col-lg-6">
          ...
          <div className="d-flex flex-wrap gap-3 mb-2">
            ...
            <a href="https://www.youtube.com/shorts/Anfzh3d0Fac?feature=share" className="magnific_popup btn-play popup-youtube">
  ...
  <div className="container mb-5 mt-5">
    ...
    <div className="container">
      ...
      category && category.map((dets,idx)=>{
          return (
             <div key={dets.id}  className="col-6 mt-2 col-sm-4 col-md-3 col-lg-2" data-aos="zoom-in" data-aos-delay={70}>
        <div className="catcard" data-filter="burgers">
          <img className="catimg" src={dets.img} alt />
          <div className="catnm">{dets.title}</div>
          <div className="catct">{dets.Item} Items </div>
        </div>
      </div>
          )
      })
